export default function Home() {
  return (
    <div className="relative flex flex-col min-h-screen w-full">
      <header className="sticky top-0 z-50 flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#292348]/50 bg-background-dark/80 backdrop-blur-md px-4 py-3 md:px-10">
        <div className="flex items-center gap-4 lg:gap-8 w-full md:w-auto">
          ...
          <label className="hidden md:flex flex-col min-w-40 !h-10 max-w-64 lg:w-64 opacity-50 pointer-events-none">
            <div className="flex w-full flex-1 items-stretch rounded-lg h-full group focus-within:ring-1 focus-within:ring-primary">
              ...
              <input className="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg text-white focus:outline-0 focus:ring-0 border-none bg-[#292348] focus:border-none h-full placeholder:text-[#9b92c9] px-4 rounded-l-none border-l-0 pl-2 text-sm font-normal leading-normal" disabled placeholder="Search..." />
            </div>
          </label>
        </div>
        ...
        <div className="w-full max-w-[1280px] px-4 md:px-10 pb-12">
          <div className="@container mt-8">
            <div className="flex flex-col gap-6 py-6 md:py-10 @[864px]:flex-row items-center">
              <div className="flex flex-col gap-6 @[480px]:gap-8 @[864px]:w-1/2 justify-center order-2 @[864px]:order-1">
                <div className="flex flex-col gap-4 text-left">
                  <div className="inline-flex w-fit items-center gap-2 rounded-full border border-primary/30 bg-primary/10 px-3 py-1 text-xs font-medium text-primary-300">
                    <span className="relative flex h-2 w-2">
                      <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-primary opacity-75"></span>
                      <span className="relative inline-flex rounded-full h-2 w-2 bg-primary"></span>
                    </span>
                    <span className="text-primary text-xs font-bold uppercase tracking-wider">New Protocol V2 Live</span>
                  </div>
                  <h1 className="text-white text-4xl font-black leading-tight tracking-[-0.033em] @[480px]:text-5xl lg:text-6xl">
                    Decentralized Monetization for Creators. <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-purple-400">Own your content.</span>
                  </h1>
                  ...
                  <div className="w-full max-w-lg mt-2 relative z-20">
                    <div className="relative group">
                      <div className="absolute -inset-1 bg-gradient-to-r from-primary to-purple-600 rounded-xl blur opacity-25 group-hover:opacity-50 transition duration-200"></div>
                      <div className="relative flex items-center bg-[#1e1933] rounded-xl border border-[#3f3863] overflow-hidden focus-within:border-primary focus-within:ring-2 focus-within:ring-primary/20 transition-all shadow-xl">
                        <div className="pl-4 text-text-muted">
                          <span className="material-symbols-outlined">search</span>
                        </div>
                        <input className="w-full bg-transparent border-none text-white placeholder-text-muted py-4 px-3 focus:ring-0 text-base" placeholder="Search creators, articles, or videos..." type="text" />
                        <div className="hidden sm:flex items-center gap-1 pr-2">
                          <select className="bg-[#292348] text-sm text-white border-none rounded-lg py-1.5 pl-2 pr-8 focus:ring-1 focus:ring-primary cursor-pointer hover:bg-[#342d5b] transition-colors">
                            <option>All</option>
                          ...
                          <button className="ml-2 bg-primary hover:bg-primary/90 text-white rounded-lg p-2 transition-colors">
                            <span className="material-symbols-outlined text-[20px]">arrow_forward</span>
                          </button>
                        </div>
                      </div>
                    </div>
                    <div className="flex gap-3 mt-3 text-xs text-text-muted pl-1">
                      <span>Popular:</span>
                      <a className="hover:text-primary transition-colors cursor-pointer underline-offset-2 hover:underline">#Web3Gaming</a>
                      <a className="hover:text-primary transition-colors cursor-pointer underline-offset-2 hover:underline">#DeFi</a>
                      <a className="hover:text-primary transition-colors cursor-pointer underline-offset-2 hover:underline">#NFTArt</a>
                    </div>
                  </div>
                </div>
                <div className="flex gap-4 flex-wrap mt-2">
                  <button className="flex min-w-[140px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-12 px-6 bg-primary hover:bg-primary/90 transition-all text-white text-base font-bold leading-normal tracking-[0.015em] shadow-[0_0_20px_rgba(55,19,236,0.3)]">
          ...
          <div className="flex gap-3 py-6 flex-wrap sticky top-[72px] z-40 bg-background-dark/95 backdrop-blur-sm border-b border-white/5 -mx-4 px-4 md:mx-0 md:px-0 md:bg-transparent md:border-none md:static">
            <button className="flex h-9 shrink-0 items-center justify-center gap-x-2 rounded-full bg-primary text-white pl-5 pr-5 hover:scale-105 transition-transform">
            ...
            <button className="flex h-9 shrink-0 items-center justify-center gap-x-2 rounded-full bg-[#292348] hover:bg-[#38315e] border border-white/5 pl-5 pr-5 transition-colors group">
              <span className="material-symbols-outlined text-[18px] text-text-muted group-hover:text-white transition-colors">article</span>
              <p className="text-text-muted group-hover:text-white text-sm font-medium leading-normal transition-colors">Articles</p>
            </button>
            <button className="flex h-9 shrink-0 items-center justify-center gap-x-2 rounded-full bg-[#292348] hover:bg-[#38315e] border border-white/5 pl-5 pr-5 transition-colors group">
              <span className="material-symbols-outlined text-[18px] text-text-muted group-hover:text-white transition-colors">mic</span>
              <p className="text-text-muted group-hover:text-white text-sm font-medium leading-normal transition-colors">Podcasts</p>
            </button>
            <button className="flex h-9 shrink-0 items-center justify-center gap-x-2 rounded-full bg-[#292348] hover:bg-[#38315e] border border-white/5 pl-5 pr-5 transition-colors group">
              <span className="material-symbols-outlined text-[18px] text-text-muted group-hover:text-white transition-colors">play_circle</span>
              <p className="text-text-muted group-hover:text-white text-sm font-medium leading-normal transition-colors">Videos</p>
            </button>
            <button className="flex h-9 shrink-0 items-center justify-center gap-x-2 rounded-full bg-[#292348] hover:bg-[#38315e] border border-white/5 pl-5 pr-5 transition-colors group">
              <span className="material-symbols-outlined text-[18px] text-text-muted group-hover:text-white transition-colors">token</span>
              <p className="text-text-muted group-hover:text-white text-sm font-medium leading-normal transition-colors">NFT Access</p>
            </button>
          </div>
          <div className="mt-8">
            <div className="flex items-center justify-between px-2 mb-6">
              ...
              <a className="text-primary hover:text-white text-sm font-medium transition-colors" href="#">View All</a>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="flex flex-col items-stretch justify-start rounded-xl overflow-hidden bg-card-dark border border-white/5 hover:border-primary/50 transition-all hover:shadow-[0_0_20px_rgba(55,19,236,0.15)] group h-full">
                ...
                <div className="flex flex-col flex-1 p-5 gap-3">
                  <div className="flex justify-between items-start">
                    <div className="flex flex-col">
                      <p className="text-primary font-bold text-sm">0.01 ETH</p>
                  ...
                  <div className="mt-auto pt-4 flex items-center justify-between border-t border-white/5">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs text-text-muted font-medium">CryptoAlice</span>
                    </div>
                    <span className="text-xs text-text-muted">5 min read</span>
                  </div>
                  <button className="w-full mt-2 flex items-center justify-center gap-2 rounded-lg h-9 bg-[#292348] hover:bg-primary text-white text-sm font-bold transition-colors">
                    Unlock Content
                  </button>
                </div>
              </div>
              <div className="flex flex-col items-stretch justify-start rounded-xl overflow-hidden bg-card-dark border border-white/5 hover:border-primary/50 transition-all hover:shadow-[0_0_20px_rgba(55,19,236,0.15)] group h-full">
                ...
                <div className="flex flex-col flex-1 p-5 gap-3">
                  <div className="flex justify-between items-start">
                    <div className="flex flex-col">
                      <p className="text-primary font-bold text-sm">50 X402</p>
                      <h3 className="text-white text-lg font-bold leading-tight line-clamp-2 mt-1 group-hover:text-primary transition-colors">The Future of DAO Governance</h3>
                    </div>
                  </div>
                  <p className="text-text-muted text-sm line-clamp-2">Interview with vitalik.eth about the scaling challenges facing decentralized organizations today.</p>
                  <div className="mt-auto pt-4 flex items-center justify-between border-t border-white/5">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs text-text-muted font-medium">DAO_Talks</span>
                    </div>
              ...
              <div className="flex flex-col items-stretch justify-start rounded-xl overflow-hidden bg-card-dark border border-white/5 hover:border-primary/50 transition-all hover:shadow-[0_0_20px_rgba(55,19,236,0.15)] group h-full">
                ...
                <div className="flex flex-col flex-1 p-5 gap-3">
                  <div className="flex justify-between items-start">
                    <div className="flex flex-col">
                      <p className="text-primary font-bold text-sm">0.02 ETH</p>
                  ...
                  <div className="mt-auto pt-4 flex items-center justify-between border-t border-white/5">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs text-text-muted font-medium">CodeWithBlock</span>
                    </div>
