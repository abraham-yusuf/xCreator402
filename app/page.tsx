            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="flex flex-col items-stretch justify-start rounded-xl overflow-hidden bg-[#1e1933] border border-white/5 hover:border-[#3713ec]/50 transition-all hover:shadow-[0_0_20px_rgba(55,19,236,0.15)] group h-full">
                ...
                <div className="flex flex-col flex-1 p-5 gap-3">
                  ...
                  <p className="text-[#9b92c9] text-sm line-clamp-2">An deep dive into the tokenomics of next-gen play-to-earn models and sustainable economies.</p>
              ...
              <div className="flex flex-col items-stretch justify-start rounded-xl overflow-hidden bg-[#1e1933] border border-white/5 hover:border-[#3713ec]/50 transition-all hover:shadow-[0_0_20px_rgba(55,19,236,0.15)] group h-full">
                ...
                <div className="flex flex-col flex-1 p-5 gap-3">
                  ...
                  <p className="text-[#9b92c9] text-sm line-clamp-2">Learn optimize gas usage and secure your smart contracts against re-entrancy attacks.</p>
                  <div className="mt-auto pt-4 flex items-center justify-between border-t border-white/5">
                    <div className="flex items-center gap-2">
